...
- When driving at night and being dazzled by the main beam headlights of a following vehicle, i.e. the vehicle immediately behind you, set your interior mirror to the anti-dazzle mode. Just behind the lower edge of the mirror is a small lever, pull this forward and you will still be able to see the lights of the vehicles behind but the dazzle will be greatly reduced. Case in point: always remember to reset the mirror by pushing the lever towards the windscreen. More modern cars will have a button under the mirror, that you can push to automatically activate the electronic anti-dazzle mode; when being dazzled the sensors will automatically detect that and switch the anti-dazzle mode on!

- Both during daytime and at night, when visibility is seriously reduced due to rain, fog or snowfall, you are allowed to use your front fog lights, either with or without using your dipped beam headlights. Case in point: you don't have to use your dipped beam headlights then; but your sidelights, rear light and rear registration plate lighting remain a requirement. When using front fog lights, main or dipped beam headlights may also be used.